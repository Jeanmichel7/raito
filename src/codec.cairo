...
pub trait Encode<T> {
    ...
    fn encode_to_wtx(self: Transaction, ref dest: ByteArray) {}

    /// Convert into bytes and return
    fn encode(
        self: T, include_witness_fields: bool
    ) -> ByteArray {
...
pub impl EncodeSnap<T, +Encode<T>, +Copy<T>> of Encode<@T> {
    ...
    fn encode(self: @T, include_witness_fields: bool) -> ByteArray {
        (*self).encode(include_witness_fields)
    }
}
...
pub impl EncodeTx of Encode<Transaction> {
    ...
    fn encode(self: Transaction, include_witness_fields: bool) -> ByteArray {
        let mut dest: ByteArray = Default::default();
        if (include_witness_fields) {
            Self::encode_to_wtx(self, ref dest);
        } else {
            Self::encode_to(self, ref dest);
        }
        dest
...
mod tests {
    ...
    fn test_encode_tx_witness2() {
        // tx 3c149efe88dae098a7ccc87ba4864d516e0a521bd840e5cc4c44b2c84868b7d6,
        let tx = Transaction {
            version: 2,
            is_segwit: true,
            lock_time: 0,
        ...
        let tx_encoded = tx.encode(false);
        let tx_expected = from_hex(
            ""
        );
        assert_eq!(to_hex(@tx_encoded), to_hex(@tx_expected));

        let wtx_encoded = tx.encode(true);
        let wtx_expected = from_hex(
            ""
        );
        assert_eq!(to_hex(@wtx_encoded), to_hex(@wtx_expected));
    }
}
