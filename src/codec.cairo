...
pub trait Encode<T> {
    ...
    /// Computes the size of a particular structure in weight units.
    fn weight(
        self: @T
    ) -> usize {
...
pub impl EncodeByteArray of Encode<ByteArray> {
    fn encode_to(self: @ByteArray, ref dest: ByteArray, witness: bool) {
        ...
        encode_compact_size(len, ref dest);
        dest.append(self);
    }
    ...
    fn weight_to(self: @ByteArray, ref weight: usize, factor: usize) {
        ...
        weight += len * factor; // ici ca va merde
    }
}
...
mod tests {
    ...
    use super::{Encode, encode_compact_size, encode_compact_size_weight, NON_WITNESS_FACTOR};
    ...
    fn test_encode_compact_size_weight1() {
        let mut weight = 0;
        encode_compact_size_weight(1, ref weight, 1);
        assert_eq!(weight, 1);
    }
    ...
    fn test_encode_compact_size_weight3() {
        let mut weight = 0;
        encode_compact_size_weight(253, ref weight, 1);
        assert_eq!(weight, 3);
    }
    ...
    fn test_encode_compact_size_weight5() {
        let mut weight = 0;
        encode_compact_size_weight(65536, ref weight, 1);
        assert_eq!(weight, 5);
    }
